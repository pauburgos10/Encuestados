...
var VistaUsuario = function(modelo, controlador, elementos) {
  ...
  this.elementos = elementos; // listaPreguntas - botonAgregar - nombreUsuario - graficosTorta
  var contexto = this;
...
VistaUsuario.prototype = {
  ...
  reconstruirLista: function() {
    ...
    preguntas.forEach(function(clave){
      ...
      elemento.attr('value', clave.textoPregunta);
      elemento.append(clave.textoPregunta);
      elemento.attr('id', clave.id);
